...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("
        INSERT INTO products (seller_id, name, description, price, stock, category, image, status, language, currency, reviews_enabled)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    if ($stmt->execute([$seller_id, $name, $description, $price, $stock, $category, $imagePath, $status, $language, $currency, $reviews_enabled])) {
